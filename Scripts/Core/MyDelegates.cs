...
namespace MyDelegates
{
    ...
    #region MyDelegats
    #region Abstract
    public abstract class MyDelegate : IInvoke<bool>
    {
    ...
    public abstract class MyDelegate<T1, T2, T3> : MyDelegate<T1, T2>
    {
    ...
    public abstract class MyDelegate<T1, T2, T3, T4> : MyDelegate<T1, T2, T3>
    {
    ...
    public abstract class MyDelegate<T1, T2, T3, T4, T5> : MyDelegate<T1, T2, T3, T4>
    {
    ...
    public class Act<T> : MyDelegate<T>
    {
        public Action<T> del;
    ...
    public class Fun<T> : MyDelegate<T>
    {
    ...
    public class ArrayAct<T> : MyDelegate<T>
    {
    ...
    public class ArrayFun<T> : MyDelegate<T>
    {
    ...
    public class Act<T1, T2> : MyDelegate<T1, T2>
    {
    ...
    public class Fun<T1, T2> : MyDelegate<T1, T2>
    {
    ...
    public class ArrayAct<T1, T2> : MyDelegate<T1, T2>
    {
    ...
    public class ArrayFun<T1, T2> : MyDelegate<T1, T2>
    {
    ...
    public class Act<T1, T2, T3> : MyDelegate<T1, T2, T3>
    {
    ...
    public class Fun<T1, T2, T3> : MyDelegate<T1, T2, T3>
    {
    ...
    public class ArrayAct<T1, T2, T3> : MyDelegate<T1, T2, T3>
    {
    ...
    public class ArrayFun<T1, T2, T3> : MyDelegate<T1, T2, T3>
    {
    ...
    public class Act<T1, T2, T3, T4> : MyDelegate<T1, T2, T3, T4>
    {
    ...
    public class Fun<T1, T2, T3, T4> : MyDelegate<T1, T2, T3, T4>
    {
    ...
    public class ArrayAct<T1, T2, T3, T4> : MyDelegate<T1, T2, T3, T4>
    {
    ...
    public class ArrayFun<T1, T2, T3, T4> : MyDelegate<T1, T2, T3, T4>
    {
    ...
    public class Act<T1, T2, T3, T4, T5> : MyDelegate<T1, T2, T3, T4, T5>
    {
    ...
    public class Fun<T1, T2, T3, T4, T5> : MyDelegate<T1, T2, T3, T4, T5>
    {
    ...
    public class ArrayAct<T1, T2, T3, T4, T5> : MyDelegate<T1, T2, T3, T4, T5>
    {
    ...
    public class ArrayFun<T1, T2, T3, T4, T5> : MyDelegate<T1, T2, T3, T4, T5>
    {
    ...
    #region OneValue
    public class Ref1Act<T> : MyDelegate<T>
    {
    ...
    public class Ref1Fun<T> : MyDelegate<T>
    {
    ...
    public class ArrayRef1Act<T> : MyDelegate<T>
    {
    ...
    public class ArrayRef1Fun<T> : MyDelegate<T>
    {
    ...
    #endregion
    #region TwoValue
    public class Ref1Act<T1, T2> : MyDelegate<T1, T2>
    {
    ...
    public class Ref2Act<T1, T2> : MyDelegate<T1, T2>
    {
    ...
    public class Ref1Fun<T1, T2> : MyDelegate<T1, T2>
    {
    ...
    public class Ref2Fun<T1, T2> : MyDelegate<T1, T2>
    {
    ...
    public class ArrayRef1Act<T1, T2> : MyDelegate<T1, T2>
    {
    ...
    public class ArrayRef2Act<T1, T2> : MyDelegate<T1, T2>
    {
    ...
    public class ArrayRef1Fun<T1, T2> : MyDelegate<T1, T2>
    {
    ...
    public class ArrayRef2Fun<T1, T2> : MyDelegate<T1, T2>
    {
    ...
    #endregion
    #region ThreeValue
    public class Ref1Act<T1, T2, T3> : MyDelegate<T1, T2, T3>
    {
    ...
    public class Ref2Act<T1, T2, T3> : MyDelegate<T1, T2, T3>
    {
    ...
    public class Ref3Act<T1, T2, T3> : MyDelegate<T1, T2, T3>
    {
    ...
    public class Ref1Fun<T1, T2, T3> : MyDelegate<T1, T2, T3>
    {
    ...
    public class Ref2Fun<T1, T2, T3> : MyDelegate<T1, T2, T3>
    {
    ...
    public class Ref3Fun<T1, T2, T3> : MyDelegate<T1, T2, T3>
    {
    ...
    public class ArrayRef1Act<T1, T2, T3> : MyDelegate<T1, T2, T3>
    {
    ...
    public class ArrayRef2Act<T1, T2, T3> : MyDelegate<T1, T2, T3>
    {
    ...
    public class ArrayRef3Act<T1, T2, T3> : MyDelegate<T1, T2, T3>
    {
    ...
    public class ArrayRef1Fun<T1, T2, T3> : MyDelegate<T1, T2, T3>
    {
    ...
    public class ArrayRef2Fun<T1, T2, T3> : MyDelegate<T1, T2, T3>
    {
    ...
    public class ArrayRef3Fun<T1, T2, T3> : MyDelegate<T1, T2, T3>
    {
    ...
    #endregion
    #region FourValue
    public class Ref1Act<T1, T2, T3, T4> : MyDelegate<T1, T2, T3, T4>
    {
    ...
    public class Ref2Act<T1, T2, T3, T4> : MyDelegate<T1, T2, T3, T4>
    {
    ...
    public class Ref3Act<T1, T2, T3, T4> : MyDelegate<T1, T2, T3, T4>
    {
    ...
    public class Ref4Act<T1, T2, T3, T4> : MyDelegate<T1, T2, T3, T4>
    {
    ...
    public class Ref1Fun<T1, T2, T3, T4> : MyDelegate<T1, T2, T3, T4>
    {
    ...
    public class Ref2Fun<T1, T2, T3, T4> : MyDelegate<T1, T2, T3, T4>
    {
    ...
    public class Ref3Fun<T1, T2, T3, T4> : MyDelegate<T1, T2, T3, T4>
    {
    ...
    public class Ref4Fun<T1, T2, T3, T4> : MyDelegate<T1, T2, T3, T4>
    {
    ...
    public class ArrayRef1Act<T1, T2, T3, T4> : MyDelegate<T1, T2, T3, T4>
    {
    ...
    public class ArrayRef2Act<T1, T2, T3, T4> : MyDelegate<T1, T2, T3, T4>
    {
    ...
    public class ArrayRef3Act<T1, T2, T3, T4> : MyDelegate<T1, T2, T3, T4>
    {
    ...
    public class ArrayRef4Act<T1, T2, T3, T4> : MyDelegate<T1, T2, T3, T4>
    {
    ...
    public class ArrayRef1Fun<T1, T2, T3, T4> : MyDelegate<T1, T2, T3, T4>
    {
    ...
    public class ArrayRef2Fun<T1, T2, T3, T4> : MyDelegate<T1, T2, T3, T4>
    {
    ...
    public class ArrayRef3Fun<T1, T2, T3, T4> : MyDelegate<T1, T2, T3, T4>
    {
    ...
    public class ArrayRef4Fun<T1, T2, T3, T4> : MyDelegate<T1, T2, T3, T4>
    {
    ...
    #endregion
    #region FiveValue
    public class Ref1Act<T1, T2, T3, T4, T5> : MyDelegate<T1, T2, T3, T4, T5>
    {
    ...
    public class Ref2Act<T1, T2, T3, T4, T5> : MyDelegate<T1, T2, T3, T4, T5>
    {
    ...
    public class Ref3Act<T1, T2, T3, T4, T5> : MyDelegate<T1, T2, T3, T4, T5>
    {
    ...
    public class Ref4Act<T1, T2, T3, T4, T5> : MyDelegate<T1, T2, T3, T4, T5>
    {
    ...
    public class Ref5Act<T1, T2, T3, T4, T5> : MyDelegate<T1, T2, T3, T4, T5>
    {
    ...
    public class Ref1Fun<T1, T2, T3, T4, T5> : MyDelegate<T1, T2, T3, T4, T5>
    {
    ...
    public class Ref2Fun<T1, T2, T3, T4, T5> : MyDelegate<T1, T2, T3, T4, T5>
    {
    ...
    public class Ref3Fun<T1, T2, T3, T4, T5> : MyDelegate<T1, T2, T3, T4, T5>
    {
    ...
    public class Ref4Fun<T1, T2, T3, T4, T5> : MyDelegate<T1, T2, T3, T4, T5>
    {
    ...
    public class Ref5Fun<T1, T2, T3, T4, T5> : MyDelegate<T1, T2, T3, T4, T5>
    {
    ...
    public class ArrayRef1Act<T1, T2, T3, T4, T5> : MyDelegate<T1, T2, T3, T4, T5>
    {
    ...
    public class ArrayRef2Act<T1, T2, T3, T4, T5> : MyDelegate<T1, T2, T3, T4, T5>
    {
    ...
    public class ArrayRef3Act<T1, T2, T3, T4, T5> : MyDelegate<T1, T2, T3, T4, T5>
    {
    ...
    public class ArrayRef4Act<T1, T2, T3, T4, T5> : MyDelegate<T1, T2, T3, T4, T5>
    {
    ...
    public class ArrayRef5Act<T1, T2, T3, T4, T5> : MyDelegate<T1, T2, T3, T4, T5>
    {
    ...
    public class ArrayRef1Fun<T1, T2, T3, T4, T5> : MyDelegate<T1, T2, T3, T4, T5>
    {
    ...
    public class ArrayRef2Fun<T1, T2, T3, T4, T5> : MyDelegate<T1, T2, T3, T4, T5>
    {
    ...
    public class ArrayRef3Fun<T1, T2, T3, T4, T5> : MyDelegate<T1, T2, T3, T4, T5>
    {
    ...
    public class ArrayRef4Fun<T1, T2, T3, T4, T5> : MyDelegate<T1, T2, T3, T4, T5>
    {
    ...
    public class ArrayRef5Fun<T1, T2, T3, T4, T5> : MyDelegate<T1, T2, T3, T4, T5>
    {
