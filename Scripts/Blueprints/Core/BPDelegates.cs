...
namespace BP.Delegates
{
    ...
    #region BPDelegats
    #region Abstract
    public abstract class BPDelegate : IInvoke<bool>
    {
    ...
    public abstract class BPDelegate<T> : BPDelegate//, IDrawGizmosSelected
    {
    ...
    public abstract class BPDelegate<T1, T2> : BPDelegate<T1>
    {
    ...
    public abstract class BPDelegate<T1, T2, T3> : BPDelegate<T1, T2>
    {
    ...
    public abstract class BPDelegate<T1, T2, T3, T4> : BPDelegate<T1, T2, T3>
    {
    ...
    public abstract class BPDelegate<T1, T2, T3, T4, T5> : BPDelegate<T1, T2, T3, T4>
    {
    ...
    public class Act : BPDelegate
    {
        ...
        public override bool Invoke() => ActInvoke(del);
        protected override void act() => del.Invoke();
    }
    public class Fun : BPDelegate
    {
        public Func<bool> del;

        public override bool Invoke() => FunInvoke(del);
        protected override bool fun() => del.Invoke();
    }

    public class Act<T> : BPDelegate<T>
    {
        public Action<T> del;
    ...
    public class Fun<T> : BPDelegate<T>
    {
    ...
    public class ArrayAct<T> : BPDelegate<T>
    {
        public List<Action<T>> dels;

        public override bool Invoke() => ActInvoke(ref dels);
        protected override void act(int i) => dels[i].Invoke(value1);
    }
    public class ArrayFun<T> : BPDelegate<T>
    {
        public List<Func<T, bool>> dels;

        public override bool Invoke() => FunInvoke(ref dels);
        protected override bool fun(int i) => dels[i].Invoke(value1);
    }

    public class Act<T1, T2> : BPDelegate<T1, T2>
    {
    ...
    public class Fun<T1, T2> : BPDelegate<T1, T2>
    {
    ...
    public class ArrayAct<T1, T2> : BPDelegate<T1, T2>
    {
    ...
    public class ArrayFun<T1, T2> : BPDelegate<T1, T2>
    {
    ...
    public class Act<T1, T2, T3> : BPDelegate<T1, T2, T3>
    {
    ...
    public class Fun<T1, T2, T3> : BPDelegate<T1, T2, T3>
    {
    ...
    public class ArrayAct<T1, T2, T3> : BPDelegate<T1, T2, T3>
    {
    ...
    public class ArrayFun<T1, T2, T3> : BPDelegate<T1, T2, T3>
    {
    ...
    public class Act<T1, T2, T3, T4> : BPDelegate<T1, T2, T3, T4>
    {
    ...
    public class Fun<T1, T2, T3, T4> : BPDelegate<T1, T2, T3, T4>
    {
    ...
    public class ArrayAct<T1, T2, T3, T4> : BPDelegate<T1, T2, T3, T4>
    {
    ...
    public class ArrayFun<T1, T2, T3, T4> : BPDelegate<T1, T2, T3, T4>
    {
    ...
    public class Act<T1, T2, T3, T4, T5> : BPDelegate<T1, T2, T3, T4, T5>
    {
    ...
    public class Fun<T1, T2, T3, T4, T5> : BPDelegate<T1, T2, T3, T4, T5>
    {
    ...
    public class ArrayAct<T1, T2, T3, T4, T5> : BPDelegate<T1, T2, T3, T4, T5>
    {
    ...
    public class ArrayFun<T1, T2, T3, T4, T5> : BPDelegate<T1, T2, T3, T4, T5>
    {
    ...
    #region OneValue
    public class Ref1Act<T> : BPDelegate<T>
    {
    ...
    public class Ref1Fun<T> : BPDelegate<T>
    {
    ...
    public class ArrayRef1Act<T> : BPDelegate<T>
    {
    ...
    public class ArrayRef1Fun<T> : BPDelegate<T>
    {
    ...
    #endregion
    #region TwoValue
    public class Ref1Act<T1, T2> : BPDelegate<T1, T2>
    {
    ...
    public class Ref2Act<T1, T2> : BPDelegate<T1, T2>
    {
    ...
    public class Ref1Fun<T1, T2> : BPDelegate<T1, T2>
    {
    ...
    public class Ref2Fun<T1, T2> : BPDelegate<T1, T2>
    {
    ...
    public class ArrayRef1Act<T1, T2> : BPDelegate<T1, T2>
    {
    ...
    public class ArrayRef2Act<T1, T2> : BPDelegate<T1, T2>
    {
    ...
    public class ArrayRef1Fun<T1, T2> : BPDelegate<T1, T2>
    {
    ...
    public class ArrayRef2Fun<T1, T2> : BPDelegate<T1, T2>
    {
    ...
    #endregion
    #region ThreeValue
    public class Ref1Act<T1, T2, T3> : BPDelegate<T1, T2, T3>
    {
    ...
    public class Ref2Act<T1, T2, T3> : BPDelegate<T1, T2, T3>
    {
    ...
    public class Ref3Act<T1, T2, T3> : BPDelegate<T1, T2, T3>
    {
    ...
    public class Ref1Fun<T1, T2, T3> : BPDelegate<T1, T2, T3>
    {
    ...
    public class Ref2Fun<T1, T2, T3> : BPDelegate<T1, T2, T3>
    {
    ...
    public class Ref3Fun<T1, T2, T3> : BPDelegate<T1, T2, T3>
    {
    ...
    public class ArrayRef1Act<T1, T2, T3> : BPDelegate<T1, T2, T3>
    {
    ...
    public class ArrayRef2Act<T1, T2, T3> : BPDelegate<T1, T2, T3>
    {
    ...
    public class ArrayRef3Act<T1, T2, T3> : BPDelegate<T1, T2, T3>
    {
    ...
    public class ArrayRef1Fun<T1, T2, T3> : BPDelegate<T1, T2, T3>
    {
    ...
    public class ArrayRef2Fun<T1, T2, T3> : BPDelegate<T1, T2, T3>
    {
    ...
    public class ArrayRef3Fun<T1, T2, T3> : BPDelegate<T1, T2, T3>
    {
    ...
    #endregion
    #region FourValue
    public class Ref1Act<T1, T2, T3, T4> : BPDelegate<T1, T2, T3, T4>
    {
    ...
    public class Ref2Act<T1, T2, T3, T4> : BPDelegate<T1, T2, T3, T4>
    {
    ...
    public class Ref3Act<T1, T2, T3, T4> : BPDelegate<T1, T2, T3, T4>
    {
    ...
    public class Ref4Act<T1, T2, T3, T4> : BPDelegate<T1, T2, T3, T4>
    {
    ...
    public class Ref1Fun<T1, T2, T3, T4> : BPDelegate<T1, T2, T3, T4>
    {
    ...
    public class Ref2Fun<T1, T2, T3, T4> : BPDelegate<T1, T2, T3, T4>
    {
    ...
    public class Ref3Fun<T1, T2, T3, T4> : BPDelegate<T1, T2, T3, T4>
    {
    ...
    public class Ref4Fun<T1, T2, T3, T4> : BPDelegate<T1, T2, T3, T4>
    {
    ...
    public class ArrayRef1Act<T1, T2, T3, T4> : BPDelegate<T1, T2, T3, T4>
    {
    ...
    public class ArrayRef2Act<T1, T2, T3, T4> : BPDelegate<T1, T2, T3, T4>
    {
    ...
    public class ArrayRef3Act<T1, T2, T3, T4> : BPDelegate<T1, T2, T3, T4>
    {
    ...
    public class ArrayRef4Act<T1, T2, T3, T4> : BPDelegate<T1, T2, T3, T4>
    {
    ...
    public class ArrayRef1Fun<T1, T2, T3, T4> : BPDelegate<T1, T2, T3, T4>
    {
    ...
    public class ArrayRef2Fun<T1, T2, T3, T4> : BPDelegate<T1, T2, T3, T4>
    {
    ...
    public class ArrayRef3Fun<T1, T2, T3, T4> : BPDelegate<T1, T2, T3, T4>
    {
    ...
    public class ArrayRef4Fun<T1, T2, T3, T4> : BPDelegate<T1, T2, T3, T4>
    {
    ...
    #endregion
    #region FiveValue
    public class Ref1Act<T1, T2, T3, T4, T5> : BPDelegate<T1, T2, T3, T4, T5>
    {
    ...
    public class Ref2Act<T1, T2, T3, T4, T5> : BPDelegate<T1, T2, T3, T4, T5>
    {
    ...
    public class Ref3Act<T1, T2, T3, T4, T5> : BPDelegate<T1, T2, T3, T4, T5>
    {
    ...
    public class Ref4Act<T1, T2, T3, T4, T5> : BPDelegate<T1, T2, T3, T4, T5>
    {
    ...
    public class Ref5Act<T1, T2, T3, T4, T5> : BPDelegate<T1, T2, T3, T4, T5>
    {
    ...
    public class Ref1Fun<T1, T2, T3, T4, T5> : BPDelegate<T1, T2, T3, T4, T5>
    {
    ...
    public class Ref2Fun<T1, T2, T3, T4, T5> : BPDelegate<T1, T2, T3, T4, T5>
    {
    ...
    public class Ref3Fun<T1, T2, T3, T4, T5> : BPDelegate<T1, T2, T3, T4, T5>
    {
    ...
    public class Ref4Fun<T1, T2, T3, T4, T5> : BPDelegate<T1, T2, T3, T4, T5>
    {
    ...
    public class Ref5Fun<T1, T2, T3, T4, T5> : BPDelegate<T1, T2, T3, T4, T5>
    {
    ...
    public class ArrayRef1Act<T1, T2, T3, T4, T5> : BPDelegate<T1, T2, T3, T4, T5>
    {
    ...
    public class ArrayRef2Act<T1, T2, T3, T4, T5> : BPDelegate<T1, T2, T3, T4, T5>
    {
    ...
    public class ArrayRef3Act<T1, T2, T3, T4, T5> : BPDelegate<T1, T2, T3, T4, T5>
    {
    ...
    public class ArrayRef4Act<T1, T2, T3, T4, T5> : BPDelegate<T1, T2, T3, T4, T5>
    {
    ...
    public class ArrayRef5Act<T1, T2, T3, T4, T5> : BPDelegate<T1, T2, T3, T4, T5>
    {
    ...
    public class ArrayRef1Fun<T1, T2, T3, T4, T5> : BPDelegate<T1, T2, T3, T4, T5>
    {
    ...
    public class ArrayRef2Fun<T1, T2, T3, T4, T5> : BPDelegate<T1, T2, T3, T4, T5>
    {
    ...
    public class ArrayRef3Fun<T1, T2, T3, T4, T5> : BPDelegate<T1, T2, T3, T4, T5>
    {
    ...
    public class ArrayRef4Fun<T1, T2, T3, T4, T5> : BPDelegate<T1, T2, T3, T4, T5>
    {
    ...
    public class ArrayRef5Fun<T1, T2, T3, T4, T5> : BPDelegate<T1, T2, T3, T4, T5>
    {
